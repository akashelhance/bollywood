...
export default function UpcomingWebSeriesComponent({ data }) {
                            ...
                            <div className="flex flex-wrap p-6">
                                ...
                                <div className="w-full md:col-span-2 mt-4">
                                    <div className="flex flex-row space-x-4">
                                        ...
                                        {movie.similar_web_series.length > 0 ? movie.similar_web_series.map((similar, i) => (
                                            <Link
                                                key={i}
                                                href="#"
                                                className="text-blue-500 hover:underline transition duration-500 ease-in-out hover:text-blue-700 font-bold"
                                        ...
                                        )) : <span className="italic">No similar series available</span>}
                                    </div>
                                </div>
                                <div className="w-full flex flex-col md:flex-row justify-end mt-4 md:mt-0 md:col-span-2">
                                    {movie.promotional_video_url ? (
                                        <Link href={movie.promotional_video_url} target="_blank" rel="noopener noreferrer">
