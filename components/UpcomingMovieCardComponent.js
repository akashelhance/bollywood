            ...
            <div className="pt-4 pb-2 flex flex-col md:flex-row ">
                {data.map((movie, index) => (
                    <div key={index} className="w-full md:w-1/2 mb-2 md:mb-0 m-2">
                        <div className="max-w-4xl mx-auto bg-white shadow-md rounded-lg overflow-hidden transition duration-300 hover:shadow-xl">
                                ...
                                <div className="w-full flex flex-col md:flex-row justify-end mt-4 md:mt-0 md:col-span-2">
                                    {movie.trailer_url ? (
                                        <Link href={movie.trailer_url} target="_blank" rel="noopener noreferrer">
                                            <button className="bg-gradient-to-r from-pink-500 to-orange-500 text-white shadow-lg rounded-b-lg font-bold py-2 px-4 rounded inline-flex items-center transform transition-transform duration-300 shadow-md hover:bg-purple-800 hover:scale-105">Watch Trailer</button>
                                        </Link>
                                    ) : (
                                        <button className="bg-gray-500 text-white font-bold py-2 px-4 rounded-full mb-2 md:mr-2 w-1/2 cursor-not-allowed" disabled>No Trailer Available</button>
                                    )}
                                </div>
                            </div>
                        </div>
